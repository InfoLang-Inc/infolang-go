...
// devKeyAuth is a legacy dev key in "key:namespace" form. The namespace is
// pinned by the credential and used as the default namespace.
//
// Deprecated: the self-hosted direct endpoint is gone; dev keys remain
// functional against the gateway for legacy setups only.
